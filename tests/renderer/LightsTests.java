...
public class LightsTests {
    ...
    /**
     * homework test with sphere
     */
    @Test
    public void sphere() {
        scene1.geometries.add(sphere);
        scene1.lights.add(new DirectionalLight(new Color(500, 300, 0), new Vector(0, 1, -1)));
        scene1.lights.add(new PointLight(new Color(500, 300, 0), new Point3D(-50, -50, 50))//
                .setKl(0.00001).setKq(0.000001));
        ...
        ImageWriter imageWriter = new ImageWriter("bdika", 500, 500);
        Render render = new Render()//
                .setImageWriter(imageWriter) //
                .setCamera(camera1) //
                .setRayTracer(new BasicRayTracer(scene1));
    ...
    public void triangle() {
        ...
        ImageWriter imageWriter = new ImageWriter("bdika2", 500, 500);
        Render render = new Render()//
                .setImageWriter(imageWriter) //
                .setCamera(camera2) //
                .setRayTracer(new BasicRayTracer(scene2));
